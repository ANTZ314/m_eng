...
- Create Custom Model (More Layers)
...
##====================================================================##
##                      2nd CUSTOM CNN MODEL                          ##
##====================================================================##
##---------------------------------------------------------------------##
## Adding more layers - Dropout and Regularization
##---------------------------------------------------------------------##
...
model.add(Conv2D(128, kernel_size=(3, 3), activation='relu'))   # Added 3rd layer
model.add(MaxPooling2D(pool_size=(2, 2)))

model.add(Flatten())
model.add(Dense(512, activation='relu'))                        # Previous Layer

model.add(Dropout(0.3))
model.add(Dense(512, activation='relu'))                        # Added Drop-out
...
## ~ RESULTS ~
## loss: 0.6935 - accuracy: 0.4940 - val_loss: 0.6933 - val_accuracy: 0.5000
