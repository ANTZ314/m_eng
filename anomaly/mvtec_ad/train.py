...
Architectures (-a):
-> mvtecCAE  |  baselineCAE  |  inceptionCAE  |  resnetCAE  |  skipCAE

Usage:
python3 train.py -d mvtec -a mvtecCAE -b 8 -l ssim -c grayscale
...
MINE:
python3 train.py -d /home/antz/Desktop/models/dataset/leather -a mvtecCAE -b 8 -l ssim -c grayscale --inspect

COLAB (dataset in working dir):
!python3 train.py -d /content/leather -a mvtecCAE -b 8 -l ssim -c grayscale --inspect
"""
...
def main(args):
    ...
    # SPYDER VERSION #
    #================#
    #input_dir = '../mvtec'                                     # orignal
    #input_dir = '/dataset/leather'                             # Colab Run
    input_dir = '/leather'     # Local Run
