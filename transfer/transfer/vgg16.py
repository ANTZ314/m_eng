...
#-------------------------------------------------------#
## LOAD IMAGE AS ARRAY
img_path = "human.jpg"             # Load test image
...
#-------------------------------------------------------#
## Main Dataset Path:
data_path = '/home/antz/0_samples/M_Eng/dataset/transfer/4class/'   # 4 dataset
...
## FIT THE MODEL
hist = custom_vgg16_model.fit(X_train, y_train, batch_size=20, epochs=40, verbose=1, validation_data=(X_test,y_test))
...
#-------------------------------------------------------#
feature= custom_vgg16_model.predict(x)                 # Predict
print(feature)
